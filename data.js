...
const FAQ = [
  ...
  { q: 'Як оплачувати?', a: 'Наложеним платежем Нової Пошти — при отриманні. Для речей під запит — передоплата 50% за реквізитами в особистих, решта перед відправленням.' },
