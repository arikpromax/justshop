...
const CFG = {
  ...
  // Продавець — за законом про електронну комерцію й вимогами банку він має
...
const FAQ = [
  ...
  { q: 'Як оплачувати?', a: 'Карткою на сайті через monobank або накладеним платежем Нової Пошти — при отриманні. Для речей під запит — передоплата 50% за реквізитами в особистих, решта перед відправленням.' },
...
const PAYMENT = [
  { t: 'Карткою на сайті', d: 'Visa, Mastercard, Apple Pay чи Google Pay на захищеній сторінці monobank. Дані картки вводите на стороні банку — ми їх не бачимо й не зберігаємо.',
...
const RETURNS = [
  ...
  { t: 'Повернення коштів', d: 'Не підійшла річ, а обміняти немає на що — повертаємо гроші протягом 7 днів після того, як річ приїде до нас.',
    list: ['Оплату карткою — на ту саму картку через monobank', 'Накладений платіж і готівку — переказом на вашу картку', 'Доставку повернення речі належної якості оплачує покупець'] }
];
